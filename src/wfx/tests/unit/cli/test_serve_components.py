...
class TestGraphAnalysis:
    ...
    def test_generate_dynamic_run_description(self):
        ...
        with patch("wfx.cli.serve_app._analyze_graph_structure") as mock_analyze:
            ...
            assert "Execute the deployed WFX graph" in description
...
class TestCommonFunctions:
    ...
    @patch("wfx.cli.common.load_flow_from_json")
    @pytest.mark.asyncio
...
def create_real_graph():
    """Helper function to create a real WFX graph with nodes/edges for serve_app."""
...
class TestFastAPIEndpoints:
    ...
    @patch("wfx.cli.common.execute_graph_with_capture")
    @patch("wfx.cli.common.extract_result_data")
...
class TestErrorHandling:
    ...
    def test_invalid_json_in_request(self, tmp_path):
        ...
        with patch("wfx.cli.serve_app.verify_api_key", return_value="test-key"):
